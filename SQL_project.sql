...
-- Le nombre de ligne du dataset
SELECT COUNT(*) AS "Nombre de ligne du dataset"
...
-- Q.2 Écrire une requête SQL pour récupérer toutes les transactions dont la catégorie est 'Clothing' (Vêtements) 
-- et la quantité vendue est supérieure à 4 au cours du mois de novembre 2022
SELECT 
	category, 
	SUM(quantity)
FROM retail_sales 
...
-- Q.7 Écrire une requête SQL pour calculer le panier moyen (ou la vente moyenne) pour chaque mois.
-- Déterminer quel a été le meilleur mois de vente (en termes de chiffre d'affaires) pour chaque année. 
SELECT 
...
-- Q.10 Écrire une requête SQL pour définir chaque tranche horaire et le nombre de commandes associé
-- Exemple : Matin <= 12h, Après-midi Entre 12h et 17h, Soir > 17h
WITH hourly_sale
AS
(
SELECT *,
